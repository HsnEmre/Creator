...
public sealed class RenderRequestDto
{
    ...
    public RenderDurationMode? RenderDurationMode { get; set; }
...
public sealed record CompleteRenderJobRequest(string OutputPath, double? ProbedRawClipDurationSeconds = null);
